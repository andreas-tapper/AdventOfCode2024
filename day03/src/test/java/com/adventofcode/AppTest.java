...
public class AppTest
{
    ...
    public void testExampleOne() throws IOException {
        ...
        assertEquals("161", answer.substring(11));
    }
    ...
    public void testProblemOne() throws IOException {
        ...
        assertEquals("184122457", answer.substring(11));
    }
    ...
    public void testExampleTwo() throws IOException {
        ...
        assertEquals("48", answer.substring(11));
    }
    ...
    public void testPartTwo() throws IOException {
        ...
        assertEquals("107862689", answer.substring(11));
    }
}